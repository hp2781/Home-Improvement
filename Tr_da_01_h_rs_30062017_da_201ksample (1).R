...
all_da_sample_223k3 = read.csv("tr_da_1_h_rs_223k_new3.csv", header = TRUE, stringsAsFactors = FALSE)
tr_da_1_h_rs = all_da_sample_223k3
...
tr_da_01_h_rs2 = tr_da_01_h_rs

tr_da_0_h_rs = subset(tr_da_01_h_rs2, DA==0 & prev_sale_date >= as.Date("2004-03-01")) 


colnames(tr_da_1_h_rs)[colnames(tr_da_1_h_rs) == 'contract_price_avg'] <- 'contract_price'
#colnames(all_da_sample_223k)[colnames(all_da_sample_223k) == 'prev_sale_date.1'] <- 'prev_sale_date2'
#all_da_sample_223k$X =NULL
#all_da_sample_223k$X.1 =NULL
#all_da_sample_223k$X.2 =NULL
#all_da_sample_223k$X.3 =NULL
#all_da_sample_223k$X.4 =NULL


tr_da_1_h_rs$contract_date2 = as.Date(tr_da_1_h_rs$contract_date2, format = '%d/%m/%Y')
tr_da_1_h_rs$prev_sale_date2 = as.Date(tr_da_1_h_rs$prev_sale_date2, format = '%d/%m/%Y')

tr_da_1_h_rs$bench_val = as.numeric(tr_da_1_h_rs$bench_val)
#tr_da_1_h_rs$bench_val2 =NULL
tr_da_1_h_rs$index_val = as.numeric(tr_da_1_h_rs$index_val)
tr_da_1_h_rs$index_val_prev_sale = as.numeric(tr_da_1_h_rs$index_val_prev_sale)
tr_da_1_h_rs$beds_cur_sale = as.integer(tr_da_1_h_rs$beds_cur_sale)
tr_da_1_h_rs$baths_curr_sale = as.integer(tr_da_1_h_rs$baths_curr_sale)
tr_da_1_h_rs$cars_curr_sale = as.integer(tr_da_1_h_rs$cars_curr_sale)

tr_da_1_h_rs$beds_prev_sale = as.integer(tr_da_1_h_rs$beds_prev_sale)
tr_da_1_h_rs$baths_prev_sale = as.integer(tr_da_1_h_rs$baths_prev_sale)
tr_da_1_h_rs$cars_prev_sale = as.integer(tr_da_1_h_rs$cars_prev_sale)

tr_da_1_h_rs$ssd_index_cur_sale2 = as.numeric(tr_da_1_h_rs$ssd_index_cur_sale2)
tr_da_1_h_rs$ssd_index_prev_sale2 = as.numeric(tr_da_1_h_rs$ssd_index_prev_sale2)
tr_da_1_h_rs$ssd_index_201609 = as.numeric(tr_da_1_h_rs$ssd_index_201609)
tr_da_1_h_rs$const_dollar_cur_price_201609 = as.numeric(tr_da_1_h_rs$const_dollar_cur_price_201609)
tr_da_1_h_rs$const_dollar_prev_price_201609 = as.numeric(tr_da_1_h_rs$const_dollar_prev_price_201609)
tr_da_1_h_rs$prev_sale_indexed_curr = as.numeric(tr_da_1_h_rs$prev_sale_indexed_curr)

colnames(tr_da_1_h_rs)[colnames(tr_da_1_h_rs) == 'value_index_cur_sale_sum'] <- 'value_index_to_next_sale'




#all_da_sample_223k$contract_date2 = as.Date(as.character(all_da_sample_223k$contract_date_max), format = '%d/%m/%Y')
#tr_da_1_h_rs$permit_date_max2 = as.Date(as.character(tr_da_1_h_rs$permit_date_max), format = "%d/%m/%Y")


test = subset(tr_da_1_h_rs, prev_sale_price >= 40000 & prev_sale_price<=5500000  &
               contract_price >= 40000 & contract_price <=5500000 
              &  as.Date(permit_date, '%d/%m/%Y') >= as.Date('2004-03-01') 
            & vacantb==0 
            & vacant_s==0 
            & vacant_bs ==0
                )  
...
tr_da_01_h_rs = merge(tr_da_0_h_rs, tr_da_1_h_rs, all.x = TRUE, all.y = TRUE)
tr_da_01_h_rs$contract_price_duplex_double_less_da = NULL
tr_da_01_h_rs$contract_price_duplex_double =NULL
tr_da_01_h_rs$contract_price_less_da =NULL
tr_da_01_h_rs$building_type_compact =NULL
tr_da_01_h_rs$building_type_compact2 =NULL
...
tr_da_01_h_rs$prevdateq = format(tr_da_01_h_rs$prevdateq, format = "%Y-%q")
...
test = subset(tr_da_01_h_rs, DA==0)

tr_da_01_h_rs$building_type_compact <- ifelse(tr_da_01_h_rs$building_type=="Carports","Carports/Garages/Sheds",ifelse(tr_da_01_h_rs$building_type=="Garages/Sheds","Carports/Garages/Sheds",ifelse(tr_da_01_h_rs$building_type=="Pergolas","Verandas/Pergolas",ifelse(tr_da_01_h_rs$building_type=="Verandahs","Verandas/Pergolas",tr_da_01_h_rs$building_type))))

tr_da_01_h_rs$building_type_compact2 = ifelse(grepl("~",tr_da_01_h_rs$building_type_compact),"Multiple_DAs", tr_da_01_h_rs$building_type_compact)
tr_da_01_h_rs$building_type_compact2 = ifelse(is.na(tr_da_01_h_rs$building_type_compact2),"Non-DA",tr_da_01_h_rs$building_type_compact2)
...
tr_da_01_h_rs = subset(tr_da_01_h_rs, building_type_compact2 != 'Multi Dwelling/Flats')
...
tr_da_01_h_rs2$purchase_date_notional = as.Date(ifelse(tr_da_01_h_rs2$DA == 1, as.Date(tr_da_01_h_rs2$permit_date,'%d/%m/%Y'), as.Date(tr_da_01_h_rs2$prev_sale_date2)))
tr_da_01_h_rs2$contract_price_duplex_double = ifelse(tr_da_01_h_rs2$building_type_compact2 == "Duplex", 2* tr_da_01_h_rs2$contract_price, tr_da_01_h_rs2$contract_price)
...
building_type_compact2 = c("Carports/Garages/Sheds","Duplex","Extension/Alteration","House/Single Dwelling"
                           ,"Multiple_DAs","Swimming Pool","Verandas/Pergolas")
...
tr_da_01_h_rs3_times$building_type_compact2 = as.factor(tr_da_01_h_rs3_times$building_type_compact2)
tr_da_01_h_rs3_times$building_type_compact2 = relevel(tr_da_01_h_rs3_times$building_type_compact2,"Non-DA")
...
cls <- split(tr_da_01_h_rs3_cond[tr_da_01_h_rs3_cond$DA==1,]$property_id, list(tr_da_01_h_rs3_cond[tr_da_01_h_rs3_cond$DA==1,]$state))
sapply(cls, function(dat) sum(!is.na(dat)))

test = subset(tr_da_01_h_rs3_cond, DA=0)
...
stargazer(m_ex_cur_prev_age2_age, m_ex_prev_age2_age, m_ex_age2_age, m_ex_age2, m, m_change, m_da2, m_da,
          ...
          add.lines = list(c("Year Fixed Effects","Yes","Yes","Yes","Yes","Yes","Yes","Yes","Yes"), 
                           c("Location Fixed Effects","Yes","Yes","Yes","Yes","Yes","Yes","Yes","Yes")),
          ...
          covariate.labels = c("DA","Carports/Garages/Sheds", "Duplex", "Extension/Alteration", "House/Single Dwelling", 
                               "Multiple DA", "Swimming Pool", "Verandas/Pergolas", "MktReturn", 
                               "Age", "Age squared" , 
